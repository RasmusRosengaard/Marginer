...
import { useSunfireSilkBoltStore } from '@/stores/sunfiresilkbolt'
import { useSettingsStore } from '@/stores/settings'
import { formatGold } from '@/utils/format'

const store = useSunfireSilkBoltStore()
    ...
    >
      <div class="header-left">
        <img
          ...
          class="item-icon-lg"
          alt="Sunfire Silk Bolt"
        />
        <div>
          <h2>Sunfire Silk Bolt</h2>
...
.footnote { font-size: 0.75rem; color: #6a7f99; }
